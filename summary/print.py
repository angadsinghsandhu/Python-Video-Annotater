...
# sample use:
# python summary/print.py '.' './summary/summary.txt' --file_extensions .py .txt .yaml .spec .md --exclude_dirs .git __pycache__ build data dist imgs legacy logs out summary
